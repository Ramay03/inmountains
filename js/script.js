...
function showResult(){
    ...
    if (userScore == questions.length){ // if user scored more than 4
        //creating a new span tag and passing the user score number and total question number
        let scoreTag = '<span>Excellent 🏆, You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if (userScore<questions.length && userScore >= 3*questions.length/4){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
    ...
    else if(userScore<questions.length/2 && userScore >=questions.length/4) { // if user scored more than 1
